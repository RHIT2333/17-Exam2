...
class Triangle(object):
    ...
    def return_doubled_triangle(self):
        ...
        neo_a = Point(self.a.x * 2, self.a.y * 2)
        neo_b = Point(self.b.x * 2, self.b.y * 2)
        neo_c = Point(self.c.x * 2, self.c.y * 2)
        neo = Triangle(neo_a, neo_b, neo_c)
        return neo
...
def run_test_return_doubled_triangle():
    ...
    expected_a = Point(40, 140)
    expected_b = Point(160, 200)
    expected_c = Point(90, 90)
    run_test_instance_variables(t2, expected_a, expected_b, expected_c)
